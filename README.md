...
### Equivalence partition  and `Boundries` in FizzBuzz

> 4 possible types of code partitions (outputs) : "Fizz" , "Buzz" , "FizzBuzz" and  Other
> 
> It's best to write `3 unit tests` for _each partition_

![Partition](./pictures/partition.png "partition")
